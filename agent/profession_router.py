"""Brain: profession routing + skill gap detection.

Decides — given a user query and the active profession — whether to stay,
switch to an existing profession, create a new one, or borrow a handful of
skills from a sibling. Backed by the main model via
...
def _build_router_messages(
    ...
    system = (
        ...
        "Given the user query and existing professions, decide ONE action:\n"
    ...
    user_content_parts = [
        f"Active profession: {active_block}",
